...
sudo apt install snapd                                  # Install snap if it isn't already
sudo apt install kdenlive                               # kdenlive
sudo apt install skanlite                               # Skanlite
sudo snap install onlyoffice-desktopeditors             # OnlyOffice
sudo apt install steam                                  # Steam
...
# Java configuration
sudo apt install openjdk-8-jdk openjdk-8-jre            # Install Java 8
